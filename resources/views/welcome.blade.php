        ...
        <style>
            ...
            *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
            ...
            body{
                ...
                background-image:
                    linear-gradient(rgba(10,31,51,.90), rgba(10,31,51,.94)),
            ...
            .bp-brand svg{flex-shrink:0}
            .bp-brand b{font-weight:500}
            .bp-brand span{color:var(--bp-ink-muted)}
            ...
            .bp-btn:hover{border-color:var(--bp-accent-2); color:var(--bp-accent-2)}
            .bp-btn--solid{
            ...
            .bp-spec-row svg{margin-left:auto; opacity:.6; flex-shrink:0}
            ...
            .bp-titleblock div:last-child{border-right:none}
            .bp-titleblock span{
                display:block;
                color:var(--bp-ink-muted);
                letter-spacing:.08em;
            ...
            .bp-reveal.d1{animation-delay:.05s}
            .bp-reveal.d2{animation-delay:.15s}
            .bp-reveal.d3{animation-delay:.25s}
            @keyframes bpFade{
                from{opacity:0; transform:translateY(10px)}
                to{opacity:1; transform:translateY(0)}
            }
            @media (prefers-reduced-motion: reduce){
                .bp-reveal{animation:none}
            }

            /* ---------- Responsive ---------- */
            @media (max-width: 860px){
                .bp-hero{grid-template-columns:1fr; gap:40px}
                .bp-titleblock{grid-template-columns:repeat(2,1fr)}
                .bp-titleblock div:nth-child(2){border-right:none}
            }
            @media (max-width: 480px){
                .bp-header .bp-wrap{flex-wrap:wrap}
                .bp-titleblock{grid-template-columns:1fr}
                .bp-titleblock div{border-right:none; border-bottom:1px solid var(--bp-line)}
                .bp-titleblock div:last-child{border-bottom:none}
            }
        </style>
    </head>
    <body>
        ...
        <header class="bp-header">
            <div class="bp-wrap">
                <div class="bp-brand">
                    ...
                    <b><img src="{{ asset('images/logo.jpeg') }}" alt="{{ config('app.name', 'Console') }} logo" style="width: 35px; height: 35px;"></b>
            ...
            <div class="bp-wrap bp-hero">
                ...
                <div>
                    ...
                    <h1 class="bp-title bp-reveal d1">
                        Every project,<br>drafted, tracked<br>and <em>signed off.</em>
                    </h1>

                    <p class="bp-sub bp-reveal d1">
                        One workspace to plan projects, assign tasks, watch budgets, and keep clients,
                        freelancers and your team reading from the same set of drawings — from first
                        sketch to final sign-off.
                    </p>
                    ...
                    <div class="bp-specs bp-reveal d2">
                        <div class="bp-spec-row">
                            ...
                            <svg width="11" height="11" viewBox="0 0 10 11" fill="none"><path d="M7.70833 6.95834V2.79167H3.54167M2.5 8L7.5 3.00001" stroke="currentColor" stroke-linecap="square"/></svg>
                        </div>
                        <div class="bp-spec-row">
        ...
        <footer class="bp-footer">
            <div class="bp-wrap">
                <div class="bp-titleblock">
                    <div><span>Project</span>{{ config('app.name', 'Console') }}</div>
                    <div><span>Sheet</span>01 / 01 — Welcome</div>
